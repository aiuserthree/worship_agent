    ...
    if not api_key:
        ...
        with st.spinner("AI가 기도로 준비하며 곡을 선정하고 있습니다... 🙏"):
            try:
                ...
                2. 찬양의 흐름이 끊기지 않도록 템포와 키(Key)를 고려하여 순서를 정하세요.
                3. 특히 1번·2번 곡(빠른 곡 2곡)은 이어서 부를 수 있도록 같은 키(Key)로 맞추거나, 반음/2도 관계 등 이어부르기 좋은 키로 선정하세요.
                4. 각 곡마다 '선곡 이유'를 2~3줄로 명확히 적어주세요.
